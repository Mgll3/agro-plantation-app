...
public class SecurityConfig {
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .requestMatchers("/", "/registro", "/login","/publication/publications/top","v1/publication/**").permitAll() // Permite acceso sin autenticación a las páginas de inicio, registro y login
