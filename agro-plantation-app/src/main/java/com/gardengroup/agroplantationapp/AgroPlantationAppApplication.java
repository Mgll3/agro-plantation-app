...
public class AgroPlantationAppApplication {
	public static void main(String[] args) {
		...
		docker build -t agro-plantation:1.6 .
		...
		docker run -d -p 8080:8080 --name agro-plantation --link mysql-standalone:mysql f6429d6d6244
		...
		docker tag agro-plantation:1.6 mgll3/agro-plantation-app:Api-v1.6
		docker tag mysql-standalone mgll3/agro-plantation-app:Mysql-v1.1

		docker push mgll3/agro-plantation-app:Api-v1.6
