...
public class AgroPlantationAppApplication {
	public static void main(String[] args) {
		...
		/*
		docker build -t agro-plantation:1.2 .
		...
		docker run -d -p 8080:8080 --name agro-plantation --link mysql-standalone:mysql 2a3dea37ef6e
		...
		docker tag agro-plantation:1.2 mgll3/agro-plantation-app:Api-v1.2
		docker tag mysql-standalone mgll3/agro-plantation-app:Mysql-v1.1
		
		docker push mgll3/agro-plantation-app:Api-v1.2
