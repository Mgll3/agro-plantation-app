...
class VoteTest {
        ...
        @DisplayName("Cambiar voto de una publicación, de positivo a negativo") // Incorrecto, no hay negativo
        @Test
        void userShouldCanToggleVote() throws Exception {
                ...
                // Se espera que no haya voto
                response2.andExpect(status().isCreated())
                                .andExpect(jsonPath("$.state", Matchers.is(true)));
