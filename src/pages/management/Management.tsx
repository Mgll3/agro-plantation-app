...
type loginUserType = "init" | "loginUser" | "loginProducer" | "loginAdmin" | "loginKoUser" | "loginKoProducer" | "loginKoAdmin";
...
export default function Management() {
	...
	const usersArray = [user1DataJson, user2DataJson, producer1DataJson, producer2DataJson, producer3DataJson, admin1DataJson];
	...
	return (
		<div className="w-full pb-20 bg-brandingLightYellow">
			...
			<div className="flex flex-col items-center py-[5vh] px-[5vw] w-[100%] font-sans">
				...
				<h2 className="font-semibold text-[24px] my-[5vh]">
					Crear Usuarios
				</h2>
							...
							registerUserState === "usersOk" && (
								<div className="relative flex flex-col items-center">
									...
									<div className="relative p-4 pt-8 border border-brandingLightGreen border-solid">
										...
										<p className="mb-1 font-montserrat">UPDATE user SET user_type_id = (SELECT id FROM user_type WHERE type = &#39;USER&#39;) WHERE email = &#39;velezmarcocontacto@gmail.com&#39;;</p>
										...
										<p className="mb-1 font-montserrat">UPDATE user SET user_type_id = (SELECT id FROM user_type WHERE type = &#39;PRODUCER&#39;) WHERE email = &#39;gabymoratrabajo@gmail.com&#39;;</p>
										<p className="mb-1 font-montserrat">UPDATE user SET user_type_id = (SELECT id FROM user_type WHERE type = &#39;PRODUCER&#39;) WHERE email = &#39;sanchezangelbarraco@gmail.com&#39;;</p>
										<p className="mb-6 font-montserrat">UPDATE user SET user_type_id = (SELECT id FROM user_type WHERE type = &#39;ADMIN&#39;) WHERE email = &#39;antoniolopez12@gmail.com&#39;;</p>
									</div>
									<Button buttonColor={buttonColorGreen} buttonFontSize={buttonFontSize} buttonWidth={buttonWidthSmall} buttonPaddingY={buttonPaddingYSmall} buttonFuncionality={closeCreateUsersAidFuncionality} />
								</div>
							)
						}
				...
				<div className="relative flex justify-center gap-16 width-[100%]">
					<div className="flex flex-col items-center">
						<div className="flex flex-col items-start">
							...
							<p className="mb-4">Contraseña:   <span className="font-bold">oem$TP5</span></p>
						</div>
						<Button buttonColor={buttonColorGreen} buttonFontSize={buttonFontSize} buttonWidth={buttonWidthSmall} buttonPaddingY={buttonPaddingYSmall} buttonFuncionality={loginAsUser1Funcionality} />
					</div>
					
					<div className="flex flex-col items-center">
						<div className="flex flex-col items-start">
							<p className="">Email:	<span className="font-bold">velezmarcocontacto@gmail.com</span></p>
							<p className="mb-4">Contraseña:   <span className="font-bold">fito$TP6</span></p>
						</div>
						<Button buttonColor={buttonColorGreen} buttonFontSize={buttonFontSize} buttonWidth={buttonWidthSmall} buttonPaddingY={buttonPaddingYSmall} buttonFuncionality={loginAsUser2Funcionality} />
					</div>
				...
				<div className="relative flex justify-center gap-16 width-[100%]">
					<div className="flex flex-col items-center">
						<div className="flex flex-col items-start">
							...
							<p className="mb-4">Contraseña:   <span className="font-bold">A%ldo1se</span></p>
						</div>
						<Button buttonColor={buttonColorGreen} buttonFontSize={buttonFontSize} buttonWidth={buttonWidthSmall} buttonPaddingY={buttonPaddingYSmall} buttonFuncionality={loginAsProducer1Funcionality} />
					</div>
					
					<div className="flex flex-col items-center">
						<div className="flex flex-col items-start">
							<p className="">Email:	<span className="font-bold">gabymoratrabajo@gmail.com</span></p>
							<p className="mb-4">Contraseña:   <span className="font-bold">A%lco6$e</span></p>
						</div>
						<Button buttonColor={buttonColorGreen} buttonFontSize={buttonFontSize} buttonWidth={buttonWidthSmall} buttonPaddingY={buttonPaddingYSmall} buttonFuncionality={loginAsProducer2Funcionality} />
					</div>

					<div className="flex flex-col items-center">
						<div className="flex flex-col items-start">
							<p className="">Email:	<span className="font-bold">sanchezangelbarraco@gmail.com</span></p>
							<p className="mb-4">Contraseña:   <span className="font-bold">A%lco6$e</span></p>
						</div>
						<Button buttonColor={buttonColorGreen} buttonFontSize={buttonFontSize} buttonWidth={buttonWidthSmall} buttonPaddingY={buttonPaddingYSmall} buttonFuncionality={loginAsProducer3Funcionality} />
					</div>
				...
				<div className="relative flex justify-center gap-16 width-[100%]">
					<div className="flex flex-col items-center">
						<div className="flex flex-col items-start">
							...
							<p className="mb-4">Contraseña:   <span className="font-bold">Tut$oms6</span></p>
						</div>
						<Button buttonColor={buttonColorGreen} buttonFontSize={buttonFontSize} buttonWidth={buttonWidthSmall} buttonPaddingY={buttonPaddingYSmall} buttonFuncionality={loginAsAdmin1Funcionality} />
					</div>
				...
				<div className="relative flex justify-center gap-20">
					<Button buttonColor={buttonColorYellow} buttonFontSize={buttonFontSize} buttonWidth={buttonWidth} buttonPaddingY={buttonPaddingY} buttonFuncionality={create5PublicationsFuncionality} />
					<Button buttonColor={buttonColorYellow} buttonFontSize={buttonFontSize} buttonWidth={buttonWidth} buttonPaddingY={buttonPaddingY} buttonFuncionality={create10PublicationsFuncionality} />
					<Button buttonColor={buttonColorYellow} buttonFontSize={buttonFontSize} buttonWidth={buttonWidth} buttonPaddingY={buttonPaddingY} buttonFuncionality={createAllPublicationsFuncionality} />
					...
					areTherePublicationsToDelete === true
						...
						: (
							<p className="font-bold">
								No hay publicaciones para eliminar!!!
							</p>
						)
				}
