...
function Testimonials() {
	...
	return (
		<div className="relative w-full h-[max-content]">
			<h2 className="w-full mb-4 md:mb-[3.6rem] text-center font-sans font-bold
				md:text-[3.5rem]">
				Testimonios de nuestros usuarios</h2>

			{/* BOTONES */}
			<button className="absolute z-20 top-[50%] -left-6 md:-left-20 w-[1rem] md:w-[2.6rem]" onClick={prevClick}>
				<img src="icons/arrow2.png" alt="To left arrow" className="rotate-180 hover:scale-125 duration-300" />
			</button>

			<button className="absolute z-20 top-[50%] -right-6 md:-right-20 w-[1rem] md:w-[2.6rem]" onClick={nextClick}>
			...
			<div className="relative flex w-full h-full overflow-hidden">
				...
				<div className="flex justify-between w-full h-full">
					...
					<div
						className={`absolute left-[-100%] z-10 flex items-center justify-center gap-2 md:gap-x-[1.15rem] w-[100%] h-full ${userRole !== "visitor" && "bg-terciary300"}`}
						ref={prevTestimonialElement}
					>
						<div className="overflow-hidden w-[60%] h-[300px] text-[19.78px] bg-white rounded-2xl border border-solid border-black 
						md:h-[560px] md:w-[45%]">
							<img
							...
							/>
							<div className="md:p-[5.014rem_5.5rem] p-4">
								<h3 className="text-[12px] font-bold md:text-[2rem] md:font-normal">{testimonialsData[prevTestimonialIndex1].header}</h3>
								<p className="mt-[1.87rem] text-[10px] md:text-[1.6rem]">{testimonialsData[prevTestimonialIndex1].mainText}</p>
							</div>
						</div>
						...
						md:h-[560px] md:w-[45%]">
							...
							/>
							<div className="md:p-[5.014rem_5.5rem] p-4">
								<h3 className="text-[12px] font-bold  md:text-[2rem] md:font-normal">{testimonialsData[prevTestimonialIndex2].header}</h3>
								<p className="mt-[1.87rem] text-[10px] md:text-[1.6rem]">{testimonialsData[prevTestimonialIndex2].mainText}</p>
							</div>
						</div>
					</div>
					...
					{/* TESTIMONIO VISIBLE */}
					<div
						className={`flex items-center justify-center gap-2 md:gap-x-[1.15rem] w-[100%] h-full ${userRole !== "visitor" && "bg-terciary300"} `}
					>
						<div className="overflow-hidden w-[60%] h-[300px] text-[19.78px] bg-white rounded-2xl border border-solid border-black
						md:h-[560px] md:w-[45%]">
							<img
							...
							/>
							<div className="md:p-[5.014rem_5.5rem] p-4">
								<h3 className="md:font-normal text-[12px] font-bold md:text-[2rem]">{testimonialsData[selectedTestimonial].header}</h3>
								<p className="mt-[1.87rem] text-[10px] md:text-[1.6rem]">{testimonialsData[selectedTestimonial].mainText}</p>
							</div>
						</div>
						<div className="overflow-hidden w-[60%] h-[300px] text-[19.78px] bg-white rounded-2xl border border-solid border-black
						md:h-[560px] md:w-[45%]">
							...
							/>
							<div className="md:p-[5.014rem_5.5rem] p-4">
								<h3 className="md:font-normal text-[12px] font-bold md:text-[2rem]">{testimonialsData[selectedTestimonial2].header}</h3>
								<p className="mt-[1.87rem] text-[10px] md:text-[1.6rem]">{testimonialsData[selectedTestimonial2].mainText}</p>
							</div>
						</div>
					</div>
					...
					<div
						className={`absolute right-[-100%] z-10 flex items-center justify-center gap-2 md:gap-x-[1.15rem] w-[100%] h-full ${userRole !== "visitor" && "bg-terciary300"}`}
					...
					>
						...
						md:h-[560px] md:w-[45%]">
							...
							/>
							<div className="md:p-[5.014rem_5.5rem] p-4">
								<h3 className="md:font-normal text-[12px] font-bold md:text-[2rem]">{testimonialsData[nextTestimonialIndex1].header}</h3>
								<p className="mt-[1.87rem] text-[10px] md:text-[1.6rem]">{testimonialsData[nextTestimonialIndex1].mainText}</p>
							</div>
						</div>
						...
						md:h-[560px] md:w-[45%]">
							...
							/>
							<div className="md:p-[5.014rem_5.5rem] p-4">
								<h3 className="md:font-normal text-[12px] font-bold md:text-[2rem]">{testimonialsData[nextTestimonialIndex2].header}</h3>
								<p className="mt-[1.87rem] text-[10px] md:text-[1.6rem]">{testimonialsData[nextTestimonialIndex2].mainText}</p>
							</div>
						</div>
					</div>
				</div>
