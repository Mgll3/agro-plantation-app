...
function AdminHomeBanner() {
	...
	const buttonFontSize =
		"text-[1.2rem] custom-500:text-[1.6rem] custom-1000:text-[1.5rem] custom-1200:text-[1.6rem] custom-1600:text-[2rem] custom-2500:text-[3rem] custom-3500:text-[4rem]";
	const buttonWidth =
		"w-[19rem] custom-500:w-[25rem] custom-1000:w-[14rem] custom-1200:w-[16rem] custom-1400:w-[20.8rem] custom-1600:w-[18rem] custom-2500:w-[29rem] custom-3500:w-[35rem]";
	...
	return (
		<div
			className="overflow-hidden relative justify-between w-full h-[100%] p-0 bg-white rounded-3xl font-sans
				custom-1000:rounded-none"
		>
			<div
				className="w-full 
					custom-1000:w-[73.34%]"
			...
			<div
				className="static top-[14%] right-0 flex flex-col w-full px-[2px] pt-[8px] pb-[12px] bg-brandingLightYellow border-grey500 border-[2px] border-t-0 border-solid rounded-bl-3xl rounded-br-3xl
				...
				custom-1000:shadow-below-right-light"
			>
				<div
					className="w-full
					custom-1000:ml-[13px]"
